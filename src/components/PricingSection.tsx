  ...
  return (
    <section className="py-12 md:py-20 px-4 bg-black/20">
      <div className="max-w-4xl mx-auto text-center">
        ...
        <Card className="bg-card-gradient backdrop-blur-sm border-gray-700 p-8 md:p-12 max-w-lg mx-auto">
          <div className="space-y-8">
            <div>
              <h3 className="text-xl md:text-2xl font-bold text-white mb-4">Premium Discord Access</h3>
              <div className="flex items-baseline justify-center gap-2">
                <span className="text-3xl md:text-5xl font-bold text-crypto-green">Premium</span>
              </div>
