...
import { Image, TrendingUp, DollarSign, Target } from "lucide-react";
  ...
  const resultCategories = [
    {
      ...
      images: [
        { placeholder: "Daily win #1", alt: "Successful BTC trade" },
        { placeholder: "Daily win #2", alt: "ETH breakout trade" },
        { placeholder: "Daily win #3", alt: "Perfect entry/exit" }
      ]
    },
    {
    ...
    },
    {
      title: "Key Setups",
      icon: Target,
      description: "Educational trade breakdowns and analysis",
      images: [
        { placeholder: "Setup analysis #1", alt: "Supply/demand zone" },
        { placeholder: "Setup analysis #2", alt: "Market structure break" },
        { placeholder: "Setup analysis #3", alt: "Liquidity grab setup" }
      ]
    }
  ];
